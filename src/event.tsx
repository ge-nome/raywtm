    ...
    const dispatch = useDispatch();
      useEffect(()=>{
        dispatch(fetchDocuments({
            ...
            eventId: 'MHDnkFFBKk4casRssnwc'
        }))
    }, [dispatch])

    
    const {id,date,about, organizers,partners,rsvp, speakers,img,title, venue} = event
            ...
            <div>
                ...
                <div className='py-10 bg-[#b8b8b830]'>
                    <div className='lg:w-[80%] w-[90%] m-[auto] grid grid-cols-2 content-center'>
                        <div className='flex gap-2 justify-items-start items-center'>RSVP'd <span className='bg-[#00b698] text-white font-bold rounded-full grid justify-items-center items-center w-[50px] h-[50px]'>{rsvp}</span></div>
